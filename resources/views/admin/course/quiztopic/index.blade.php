              ...
              <form id="demo-form2" method="post" action="{{url('admin/quiztopic/')}}" data-parsley-validate class="form-horizontal form-label-left">
                ...
                <div class="row display-none">
                  <div class="col-md-12">
                    ...
                    <input type="hidden" placeholder="Enter Due Days" class="form-control" name="0" id="exampleInputTitle" >
                  

                 <div class="row">
                  <div class="col-md-12">
                    <label for="exampleInputTit1e">Exam Time Duration:</label>
                    <small>(In Minutes)</small>
                    <input type="number" placeholder="Enter Minutes" class="form-control" name="timeduration" id="exampleInputTitle" >
                  </div>
                </div>
                <br>
